      ...
      <div
        ...
        <div class="relative">
          ...
          <span class="absolute z-20"
                :style="{ color: form.color, opacity: form.opacity, fontSize: `${form.size / imageRatio}px`, top: `${form.position_y/imageRatio}px`, left: `${form.position_x/imageRatio}px`, fontFamily: fontList.find(font => font._id === form.font)?.font_name }"
          >    {{ form.content }}  </span>
        </div>
        <div class="relative">
          ...
          <div class="flex gap-5">
            <div class="flex flex-col w-full">
              ...
              <el-select v-model="form.font" placeholder="Select font">
                                <el-option value="Arial" label="Arial, sans-serif"/>
                                <el-option value="Roboto" label="Roboto, sans-serif"/>
